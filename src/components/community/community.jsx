...
import { MDBNavbar, MDBNavbarBrand, MDBNavbarNav, MDBNavItem,
    ...
    MDBDropdownItem, MDBIcon, MDBSideNavLink, MDBSideNavNav,
    MDBSideNavCat, MDBSideNav, MDBRow,MDBBtn} from 'mdbreact';
                ...
                <MDBNavbar color="default-color" dark expand="md">
                    ...
                    <MDBCollapse id="navbarCollapse3" isOpen={isOpen} navbar>
                        <MDBNavbarNav left>
                            ...
                            <MDBNavItem>
                                <MDBNavLink to="#!">팁 게시판</MDBNavLink>
                            </MDBNavItem>
                            <MDBNavItem>
                                <MDBNavLink to="#!">이사 정보</MDBNavLink>
                            </MDBNavItem>
                            <MDBNavItem>
                                <MDBNavLink to="#!">질문과 답변</MDBNavLink>
                            </MDBNavItem>
                            <MDBNavItem>
                                <MDBNavLink to="#!">이사 후기</MDBNavLink>
                            </MDBNavItem>
                            <MDBNavItem>
                                <MDBDropdown>
